...
<section class="navbar-default sidebar" role="navigation">
	<div class="sidebar-nav navbar-collapse">
		<ul class="nav" id="side-menu">
            ...
            <li>
				<a href="#"><?= FA::fw('tasks') ?> Campañas <span class="fa arrow"></span></a>
				<?= MetisNav::widget([
					'encodeLabels' => false,
					'options' => ['class' => 'nav nav-second-level'],
					'items' => [
						['label' => 'Ingresar Campaña', 'url' => ['/site/page', 'view' => 'flot']],
						['label' => 'Listar Campañas', 'url' => ['/site/page', 'view' => 'morris']],
                        ['label' => 'Modificar Campaña', 'url' => ['/site/page', 'view' => 'morris']],
                        ['label' => 'Eliminar Campaña', 'url' => ['/site/page', 'view' => 'morris']],
					],
				//array('label'=>'About', 'url'=>array('/site/page', 'view'=>'about')),
				]) ?>
			</li><!-- Campañas educativas-->
            
            <li>
				<a href="#"><?= FA::fw('tasks') ?> Tramites <span class="fa arrow"></span></a>
				<?= MetisNav::widget([
					'encodeLabels' => false,
					'options' => ['class' => 'nav nav-second-level'],
					'items' => [
						['label' => 'Ingresar Trámite', 'url' => ['/site/page', 'view' => 'flot']],
						['label' => 'Listar Trámites', 'url' => ['/site/page', 'view' => 'morris']],
                        ['label' => 'Modificar Trámite', 'url' => ['/site/page', 'view' => 'morris']],
                        ['label' => 'Eliminar Trámite', 'url' => ['/site/page', 'view' => 'morris']],
					],
				//array('label'=>'About', 'url'=>array('/site/page', 'view'=>'about')),
				]) ?>
			</li><!-- Tramites -->    
            ...
            <li>
				<a href="#"><?= FA::fw('user') ?> Administradores <span class="fa arrow"></span></a>
				<?= MetisNav::widget([
					'encodeLabels' => false,
					'options' => ['class' => 'nav nav-second-level'],
					'items' => [
						['label' => 'Ingresar', 'url' => ['/site/page', 'view' => 'flot']],
						['label' => 'Listar', 'url' => ['/site/page', 'view' => 'morris']],
                        ['label' => 'Modificar', 'url' => ['/site/page', 'view' => 'morris']],
                        ['label' => 'Eliminar', 'url' => ['/site/page', 'view' => 'morris']],
					],
				//array('label'=>'About', 'url'=>array('/site/page', 'view'=>'about')),
				]) ?>
			</li><!-- Usuarios Administradores -->
            
              <li>
				<a href="#"><?= FA::fw('user') ?> Usuarios Discapacitados <span class="fa arrow"></span></a>
				<?= MetisNav::widget([
					'encodeLabels' => false,
					'options' => ['class' => 'nav nav-second-level'],
					'items' => [
			...
			</li><!-- Usuarios Dispacitados -->
            
            
              <li>
				<a href="#"><?= FA::fw('user') ?> Usuarios simple <span class="fa arrow"></span></a>
				<?= MetisNav::widget([
					'encodeLabels' => false,
					'options' => ['class' => 'nav nav-second-level'],
					'items' => [
			...
			<li>
				<a href="#"><?= FA::fw('user') ?> Charts <span class="fa arrow"></span></a>
				<?= MetisNav::widget([
					'encodeLabels' => false,
					'options' => ['class' => 'nav nav-second-level'],
					'items' => [
